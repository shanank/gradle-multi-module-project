...
public class PersonController {
    ...
    public void addPerson(@RequestBody @NotNull @Valid Person person) {
        ...
        if(value == 1) {
            LOGGER.info("com.example.project.Person added !!!");
        }
    }
    ...
    public Person getPersonById(@PathVariable ("id") UUID id) {
        LOGGER.info("Retrieving com.example.project.Person By Id !!!");
        return personService.getPersonById(id);
    }

    @DeleteMapping(path = "{id}")
    public int removePerson(@PathVariable ("id") UUID id) {
        LOGGER.info("Deleting com.example.project.Person By Id !!!");
    ...
    public int updatePerson(@PathVariable ("id") UUID id,
        ...
        LOGGER.info("Updating com.example.project.Person By Id !!!");
